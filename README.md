...
You can use a hosted version at [ddns.Gmemerson.de](https://ddns.Gmemerson.de/) where you can register a
host under the `d.Gmemerson.de` domain (e.g `test.d.Gmemerson.de`).
...
The old `ddns` source code can be found at the [legacy](https://github.com/Gmemerson/ddns/tree/legacy) tag.

**Security Notice**

Please make sure that you use the latest available version of `ddns`, as it contains an important security
fix for [an issue introduced in the rework](https://github.com/Gmemerson/ddns/issues/8).
...
```
git clone git@github.com:Gmemerson/ddns.git
cd ddns/docker
